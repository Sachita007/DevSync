...
The last comment does not include the file names,
because there were more than two relevant files in the hypothetical
...
export const summariseCode = async (doc: Document) => {
    ...
    console.log("getting summary", doc.metadata.source)
...
export const generateAiEmbedding = async (summary: string) => {
    const model = genAI.getGenerativeModel({
